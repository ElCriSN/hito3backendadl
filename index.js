...
const { addProduct, registerUser, getProduct, getProducts ,checkCredentials, getUsers, prepareHATEOAS, reportQuery, deleteProduct } = require('./consulta')
...
app.post("/adminaddproduct", reportQuery,  async (req,res) => {
